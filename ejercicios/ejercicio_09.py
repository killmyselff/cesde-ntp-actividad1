...
# Ejercicio 2: Pide al usuario que ingrese su ciudad de residencia y su país de origen (en dos variables e inputs separados).
...
# Ejercicio 3: Pide al usuario que escriba una palabra sencilla y luego impríela repetida 5 veces
